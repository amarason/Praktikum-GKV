...
void KotakKayu()
{
	...
	glTranslatef(0, 0, 3);
	glBegin(GL_QUADS);
	glColor3ub(180, 50, 90);
	glVertex3f(-3.0f, -3.0f, 0.0f);
	glColor3ub(220, 120, 160);
	glVertex3f(3.0f, -3.0f, 0.0f);
	glColor3ub(160, 40, 80);
	glVertex3f(3.0f, 3.0f, 0.0f);
	glColor3ub(250, 180, 200);
	glVertex3f(-3.0f, 3.0f, 0.0f);
	glEnd();
	glPopMatrix();
	...
	glTranslatef(0, 0, 3);
	glBegin(GL_QUADS);
	glColor3ub(180, 60, 100);  
	glVertex3f(3.0f, -3.0f, 0.0f);
	glVertex3f(3.0f, 3.0f, 0.0f);
	glColor3ub(250, 190, 210); 
	glVertex3f(-3.0f, 3.0f, 0.0f);
	glVertex3f(-3.0f, -3.0f, 0.0f);
	glEnd();
	glPopMatrix();
	...
	glTranslatef(0, 0, 3);
	glBegin(GL_QUADS);
	glColor3ub(200, 100, 140); 
	glVertex3f(3.0f, -3.0f, 0.0f);
	glVertex3f(3.0f, 3.0f, 0.0f);
	glColor3ub(255, 190, 220); 
	glVertex3f(-3.0f, 3.0f, 0.0f);
	glVertex3f(-3.0f, -3.0f, 0.0f);
	glEnd();
	glPopMatrix();
	...
	glTranslatef(0, 0, 3);
	glBegin(GL_QUADS);
	glColor3ub(200, 80, 130);  
	glVertex3f(3.0f, -3.0f, 0.0f);
	glVertex3f(3.0f, 3.0f, 0.0f);
	glColor3ub(255, 180, 220); 
	glVertex3f(-3.0f, 3.0f, 0.0f);
	glVertex3f(-3.0f, -3.0f, 0.0f);
	glEnd();
	glPopMatrix();
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("3D Lighting Amara");
